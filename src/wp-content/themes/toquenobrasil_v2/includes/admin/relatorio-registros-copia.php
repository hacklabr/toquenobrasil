...
$sql_capability = isset($_GET['user_type']) && $_GET['user_type'] ? 
					"$wpdb->usermeta.meta_value LIKE '%".$_GET['user_type']."%'" : 
...
<div id='registros-por-dia' class='graph' style='width:97%; height:250px;'></div>

<h4>acumulado no período</h4>
<div id='acumulado-por-dia' class='graph' style='width:97%; height:250px;'></div>
