			...
			<div class="span-11 last">
				<p>
					<?php if(current_user_can('select_artists') || current_user_can('select_other_artists')  || $curauth-ID == $current_user->ID ):?>
						<strong>Responsável:</strong> <?php echo $curauth->responsavel; ?>
						<br/>
						<strong>Telefone:</strong> <?php echo $curauth->telefone_ddd; ?> <?php echo $curauth->telefone; ?>
						<br/>
						<strong>E-mail:</strong> <a href="mailto:<?php echo $curauth->user_email; ?>"><?php echo $curauth->user_email; ?></a>
						<br/>
					<?php endif;?>
					<strong>Site:</strong> <a href="<?php echo $curauth->site; ?>"><?php echo $curauth->site; ?></a><br/>
