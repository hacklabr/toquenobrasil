...
if(isset($_POST['action']) && $_POST['action'] == 'register'){
    ...
    if(!sizeof($errors)>0){
        ...
        if($reg_type == 'artista' || $reg_type == 'produtor'){
            // Mensagem inserida via admin do WP
            $message = $options['msg_novo_'.$reg_type]?$options['msg_novo_'.$reg_type]:'';
                ...
                <h3 class='no-margin'><?php _e('Dados do Artista/Banda', 'tnb');?></h3>
                            ...
                            <div class="span-6">
                             ...
                             <div class="span-6">
                                ...
                                <br />
                                <input class="span-6 text" type="text" id="telefone" name="telefone" value="<?php echo $user->telefone; ?>" />
                    ...
                    <div id="produtores" class="item blue">
                        <form class="background clearfix"  method="POST">
                           <?php if($regtister_succes['produtor']):?>
                            <?php _e('Seu cadastro foi realizado com sucesso! <br />
                            Bem vindo ao TNB, verifique seu email para ativar sua conta (lembre-se de verificar o lixo eletrônico) e caso não tenha recebido um email de cadastro, favor entre em contato com contato@toquenobrasil.com.br ', 'tnb');?>
                          <?php elseif($activated):?>
                            <?php _e('Seu cadastro foi ativado.', 'tnb');?>
                          <?php else:?>
                            <input type="hidden" name="action" value="register" />
                            ...
                            <div class="span-6">
                                ...
                                <small><?php _e('Link para o site do produtor, se existir.');?></small>
                            </div>
                            <div class='clear'></div>

                            <div class="span-6">
                                <label for="cpf"><?php _e('CPF:', 'tnb');?></label>
                                <br />
                                <input class="span-6 text" type="text" id="cpf" name="cpf" value='<?php echo $user->cpf; ?>' />
                            </div>
                            <div class="span-6">
                                <label for="cnpj"><?php _e('CNPJ:', 'tnb');?></label>
                                <br />
                                <input class="span-6 text" type="text" id="cnpj" name="cnpj" value='<?php echo $user->cnpj; ?>'/>
                                <small><?php _e('CNPJ do produtor.');?></small>
                            </div>
                            <div class='clear'></div>
                            ...
                            <div class="span-6">
                                ...
                                <br />
                                <input class="span-6 text" type="text" class='telefone' id="produtor_telefone" name="telefone" value="<?php echo $user->telefone; ?>" />
                                <small><?php _e('Telefone completo. Ex: +55 11 5555 0111', 'tnb'); ?></small>
                            </div>
<div class='clear'></div>
                            <div class="span-6">
