...
$this->themeSettings = array(
    'iam-artist' => __('Link para "Sou Artista"', 'ph'),
    'iam-producer' => __('Link para "Sou Produtor"', 'ph'),
);
...
$this->themeSettingsDefaults = array(
    'iam-artist' => get_bloginfo(url) . "/como-participar/artista",
    'iam-producer' => get_bloginfo(url) . "/como-participar/produtor",
);
